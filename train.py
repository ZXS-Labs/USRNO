...
def make_data_loader(spec, tag=''):
    ...
    #if tag=='val': dataset = datasets.make(spec['patch'], args={'dataset': dataset})
    ...
    #loader = CudaDataLoader(loader,device = torch.cuda.current_device(),queue_size = 13)
    return loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config',default='./configs/train_edsr-srno.yaml')
    parser.add_argument('--name', default=None)
    parser.add_argument('--tag', default=None)
    parser.add_argument('--gpu', default='0,1')
    #parser.add_argument('--gpu', default='8,9,10,11,12,13,14,15')
